...
|---|---|---|---|---|
| 1 | 149.19 | 136.34 | 103.30 (MPI=32 OMP=4) | 30.8 |
...
| 2 | 0.601 | 0.595 | 0.716 (MPI=16 OMP=8) |
| 4 | 0.287 | 0.272 | 0.457 (MPI=16 OMP=8) |
| 8 | - | - | 0.225 (MPI=16 OMP=8) |
...
![OMP-speedup](../results/images/omp_speedup_sedov-amr_lvl5-10_meluxina.png)
## Memory usage
...
|---|---|---|---|---|---|---|---|---|
| 1 | 53.88 GB | 21.83 GB | 12.54 GB | 9.41 GB | 8.19 GB | 7.51 GB | 7.28 GB | 13.5 % |
